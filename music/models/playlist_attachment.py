...
class PlaylistAttachmentStates(StateGraph):
...
class PlaylistAttachment(StatorModel):
    """
    An attachment to a Playlist. Could be an image, a video, etc.
    """
    ...
    state = StateField(graph=PlaylistAttachmentStates)
    ...
    def thumbnail_url(self) -> RelativeAbsoluteUrl:
        if self.thumbnail:
            ...
            return ProxyAbsoluteUrl(
                f"/proxy/playlist_attachment/{self.pk}/",
